...
const CustomerInfo1 = (props) => {
    ...
    const handleTimeSlotCardChange = (e)=>{
        setIsAddNumberOpen(false);
        setIsAddDeliveryAddressOpen(false);
        setIsOrderOpen(false);
                ...
                <div className={classes.root}>
                    ...
                    <form className={classes.form} action="">
                        ...
                        >
                            ...
                            {isAddNumberOpen && (
                                <>
                                    ...
                                    <div className={classes.btn} onClick={e => { e.stopPropagation(); handleDeliveryCardChange() }} >
                                        <GeneralCustomButton
                                            text={'Add Number'}
                                        />
                            ...
                            {isAddDeliveryAddressOpen && (
                                <>
                                    ...
                                    {/* <div style={{
                                        ...
                                        {locationListShow && <LocatoionList locationList={locationList} />}
                                    </div> */}

                                    {/* <div onClick={e => { e.stopPropagation(); handleOrderCardChange() }} >
                                        <GeneralCustomButton
                                    ...
                                    <div className={classes.newAddress}>
                                        ...
                                        <div>
                                            <h4>Added Address:</h4>
                                            {/* <h5>{props.auth.preferedAddres}</h5> */}
                        ...
                        <div
                            ...
                            onClick={(e) =>
                                mobileNumber !== null && address !== null
                                    ? handleTimeSlotCardChange(e)
                                    : null
                            }
                        >
                            <h1>Choose a Time Slot </h1>
                            {timeSlot=="" ? <p> pick a time slot where you will be free to recieve your order </p> : <p>{timeSlot}</p>} 
                            <p></p>
                            {isTimeSlotOpen && (
                                <>
                                  
                                        <div >
                                    <select class="select" onChange={handleTimeSlotChange}>
                                    <option value="1">select a time slot </option>
                                    <option value="Tommorrow 10 AM">Tommorrow 10 AM</option>
                                    <option value="Tommorrow 5 PM">Tommorrow 5 PM</option>
                                </select>
                              </div>
